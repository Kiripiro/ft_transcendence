...
function Login(props: { user?: any }) {
	...
	function onClick42Login() {
		window.open(`https://api.intra.42.fr/oauth/authorize?client_id=f4c0d93db7acf37cb140cce5da2617265ab63195b7a60bcd981003b3d289a413&redirect_uri=http%3A%2F%2F172.16.1.10%3A5001%2Fauth%2Flogin&response_type=code`, '_self')
	}

	function onClickLoginSans42() {
		window.open(`http://172.16.1.10:5001/auth/loginSans42/` + login, '_self')
	}
